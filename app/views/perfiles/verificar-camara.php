...
<?php
$extraJs = '<div id="cam-verif-config"'
    . ' data-endpoint="' . APP_URL . '/perfil/' . (int)$idPerfil . '/verificar/video"'
    . ' data-csrf-token="' . e($csrfToken ?? '') . '"'
    . ' style="display:none"></div>'
    . '<script src="' . APP_URL . '/public/assets/js/verificar-camara.js" defer></script>';
?>
