...
<?php
$extraJs = '<div id="perfil-create-config"'
    . ' data-base-url="'     . e(APP_URL) . '"'
    . ' data-old-estado="'   . (int)$oldEstado . '"'
    . ' data-old-municipio="' . (int)$oldMunicipio . '"'
    . ' data-old-desc="'     . e($old['descripcion'] ?? '') . '"'
    . ' data-has-old="'      . (!empty($old) ? '1' : '0') . '"'
    . ' style="display:none"></div>'
    . '<script src="' . APP_URL . '/public/assets/js/perfil-create.js" defer></script>';
?>
