...
<?php
$descripcionEsc = htmlspecialchars((string)($perfil['descripcion'] ?? ''), ENT_QUOTES, 'UTF-8');
$extraJs = '<div id="perfil-edit-config" data-descripcion="' . $descripcionEsc . '" style="display:none"></div>'
    . '<script src="' . APP_URL . '/public/assets/js/perfil-edit.js" defer></script>';
?>
